...
Hero: Moaz the Warrior
Student ID: 16005191
GitHub account: moazelsebaei

A **Stone Golem** bars the way near **the Delta marshes**. It only falls to
the exact blow.
...
1. Your hero name
2. Your student ID
3. Your power — your student ID **multiplied by 8**
4. Your warcry — copy the line below exactly, including punctuation:

   "By the Delta marshes, the Stone Golem falls!"
